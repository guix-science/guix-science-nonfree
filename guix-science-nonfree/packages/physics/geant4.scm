...
(define-module (guix-science-nonfree packages physics geant4)
  ...
  #:use-module  (guix-science-nonfree packages physics others)
  ...
  (package
   ...
   (source
    (origin
     ...
     (snippet
      '(begin
         ;; (6 oct 2023) error: ambiguating new declaration of
         ;; ‘G4double fsqrt(G4double)’
	 (substitute*
          "source/persistency/ascii/src/G4tgrEvaluator.cc"
          (("G4double fsqrt") "G4double g4_fsqrt")
          (("\\*fsqrt") "*g4_fsqrt"))        
         ))))
