...
physics vectors, geometry and linear algebra.  CLHEP is structured in
a set of packages independent of any external package.")
              ...
              (let ((datadir (string-append #$output
                ...
                (for-each
                 ...
                 (list #$(this-package-native-input "G4NDL")
                       #$(this-package-native-input "G4EMLOW")
                       #$(this-package-native-input "G4PhotonEvaporation")
                       #$(this-package-native-input "G4RadioactiveDecay")
                       #$(this-package-native-input "G4PARTICLEXS")
                       #$(this-package-native-input "G4PII")
                       #$(this-package-native-input "G4RealSurface")
                       #$(this-package-native-input "G4SAIDDATA")
                       #$(this-package-native-input "G4ABLA")
                       #$(this-package-native-input "G4INCL")
                       #$(this-package-native-input "G4ENSDFSTATE")
                       #$(this-package-native-input "G4TENDL")))))))
      #:tests? #f))
